...
if (!empty($_COOKIE['jmy_lang'])) 
	{
		$lang = $_COOKIE['jmy_lang'];	
	}
else 
	{
		$lang = 'ru';
	}
require_once ROOT . 'install/lang/'.$lang.'.install.php';
			...
			<section class="panel no-border profile-panel overflow-hidden">
				<div class="panel-body bg-ccc">
					...
					<div class="mg-b-sm text-center text-white">
						...
						<h6 class="no-margin">Русский язык</h6>
						<small>Автор: Комаров Иван</small>
					</div>
				</div>
				<div class="panel-footer bg-white no-border">
					<div align="center">
						<button type="button" class="btn btn-success" onclick="window.location = \'install.php?step=0_ru\';" />Продолжить</button>
					</div>
				</div>
			</section>
		</div>
			...
			<section class="panel no-border profile-panel overflow-hidden">
				<div class="panel-body bg-ccc">
					...
					<div class="mg-b-sm text-center text-white">
						...
						<h6 class="no-margin">English</h6>
						<small>Author: Anton Pavlov</small>
					</div>
				</div>
				<div class="panel-footer bg-white no-border">
					<div align="center">
						<button type="button" class="btn btn-success" onclick="window.location = \'install.php?step=0_en\';" />Continue</button>
					</div>
				</div>
			</section>
		</div>';	
